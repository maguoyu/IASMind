...
import FileManagementEnhanced from "./components/file-management-enhanced";

export default function TestFileManagement() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">文件管理功能测试</h1>
